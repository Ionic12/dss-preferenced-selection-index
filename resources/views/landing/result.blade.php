                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="row justify-content-center mt-1">
                                            <div class="col-12">
                                                ...
                                                <div class="col-10">
                                                    <p>The PSI method was used to evaluate various options and determine the most suitable one based on the user's needs and preferences. Option {{ $highestRanking->tabel }} had the highest PSI value of {{ $highestRanking->rank }}, indicating that it was the most recommended option. This conclusion was based on a careful analysis of the data and consideration of various factors, making it the best choice for the user to achieve their desired outcome.</p>
